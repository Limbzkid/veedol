...
($ => {
  ...
  $(".btn-search-trigger").on("click", function (e) {
    if (!$(this).closest("form").hasClass("open")) {
      e.preventDefault();
      $(this).closest("form").find(".search-wrapper input").trigger("focus");
      $(this).closest("form").addClass("open");
      $(this).closest("form").find(".search-wrapper").css("top", "unset");
    }

    if (window.innerWidth < 1024) {
      e.preventDefault();
      $(this).closest("form").find(".search-wrapper").css("top", $("header").height());
      $(this).closest("form").find(".search-wrapper").slideToggle("fast");
    }
  });
  $(document).on("click", function (e) {
    if ($(e.target).closest(".form-search").length == 0) {
      ...
      if (window.innerWidth < 1024) {
        $(".form-search").find(".search-wrapper").slideUp("fast");
      }
    }
  });
  /** Popups */
