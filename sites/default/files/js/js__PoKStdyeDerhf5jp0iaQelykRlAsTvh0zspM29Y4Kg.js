...
($ => {
  ...
  $(".search-block-form").find('[type="submit"]').on("click", function (e) {
    if (!$(this).closest("form").hasClass("open")) {
      e.preventDefault();
      $(this).closest("form").find(".form-item input").trigger("focus");
  ...
  $(document).on("click", function (e) {
    if ($(e.target).closest(".search-block-form").length == 0) {
      $(".search-block-form").removeClass("open");

      if (window.innerWidth < 1200) {
        $(".search-block-form").find(".form-item").slideUp("fast");
      }
    }
  });
  /** Popups */
  ...
  const milestoneSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__.default(".years-container .swiper-container", {
    ...
    navigation: {
      nextEl: $(".years-container .swiper-button-next")[0],
      prevEl: $(".years-container .swiper-button-prev")[0]
    },
    on: {
      init: function () {
  ...
  $(".years-container").on("click", "a", function (e) {
    e.preventDefault();
    $("html, body").animate({
      scrollTop: $($(e.target).attr("href")).offset().top - (window.innerWidth < 1024 ? 140 : 0)
    }, 300);
  ...
  $(document).on("touchmove DOMMouseScroll mousewheel wheel", function (e) {
    ...
    $.each($(".milestone"), function (i, e) {
      const eTop = Math.ceil($(this).offset().top) - (window.innerWidth < 1024 ? 80 : 0),
...
(function ($, Drupal) {
  ...
  $(window).on('load', function() {
    $.ajax({
      ...
      success: function (resp) {
        if(resp != '') {
          if(resp == 'product') {
            var bid = '.'+ 'product-category-filter';
            setTimeout(function(){
              $('html, body').animate({
  ...
  $(document).on('click', '.product-category-filter li a', function() {
    $.ajax({
      url: drupalSettings.path.baseUrl + "set-page-id",
      type: 'POST',
      data: {
