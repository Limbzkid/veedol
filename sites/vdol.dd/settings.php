...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_vdol_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_vdol_dd.inc';
}
// </DDSETTINGS>

$settings['config_sync_directory'] = 'sites/default/files/config_acqTmp-2021-07-17T16.19.27-0392';
